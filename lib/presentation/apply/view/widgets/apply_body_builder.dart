...
class ApplyBodyBuilder extends StatefulWidget {
  const ApplyBodyBuilder({super.key});

  @override
  State<ApplyBodyBuilder> createState() => _ApplyBodyBuilderState();
}

class _ApplyBodyBuilderState extends State<ApplyBodyBuilder> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: Validations.validateText,
                style: theme.textTheme.bodyMedium,
                key: const Key(WidgetsKeys.kApplyScreenVehicleNumberFormField),
                decoration: InputDecoration(
                      ...
                      onPressed: value
                          ? () {
                              if (_globalKey.currentState!.validate()) {
                                cubit.doIntent(ApplySendDataEvent());
                              }
                            }
                          : null,
                      child: Text(
