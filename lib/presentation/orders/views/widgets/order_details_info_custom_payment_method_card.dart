...
class OrderDetailsInfoCustomPaymentMethodCard extends StatelessWidget {
  final String paymentMethod;
  const OrderDetailsInfoCustomPaymentMethodCard({super.key,required this.paymentMethod});
